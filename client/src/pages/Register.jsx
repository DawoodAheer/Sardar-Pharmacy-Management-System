      ...
      <div className="hidden md:flex md:w-[45%] flex-col justify-between bg-[#0C1628] p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 my-auto py-12 max-w-lg">
          ...
          <p className="text-slate-400 text-sm mt-6 font-medium leading-relaxed">
            Create your customer account and manage your medicine shopping,
            history, invoices, and reminders from one secure place.
          </p>
        </div>
        ...
        <div className="max-w-lg w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {password && (
                <span
                  className={`text-[11px] font-semibold mt-1.5 block transition-colors duration-300 ${strength.textClass}`}
                >
